import { DataSource, EntityManager, Between,FindOptionsWhereProperty as ORMFindOptionsWhere ,FindManyOptions,FindOptionsOrder as ORMFindOptionsOrder, FindOptionsRelations as ORMFindOptionsRelations, FindOptionsWhere, Repository, FindOptionsSelect } from "typeorm";
import { IBaseEntity } from "@/domain/entities/base-entity";
import { IBaseRepository } from "@/infra/database/interface";
...
export class BaseRepository<T extends IBaseEntity, H = T>  implements IBaseRepository<T,H>{
  ...
  constructor(
      ...
      this._overrideMapper = overrideMapper
