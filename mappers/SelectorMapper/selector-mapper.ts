...
import { ISelectorMapper } from "./selector-mapper.interface";

export class SelectorMapper implements ISelectorMapper {
  ...
  /**
    ...
    * 
  */
  private selectProperties<K, T extends Path<any>[]>(obj: K, paths: T): ISelectorMapper.merged<TupleToUnion<T>> {
    return paths.reduce((acc, path) => {
      ...
      return acc;
    }, {} as ISelectorMapper.merged<TupleToUnion<T>>);
  }
